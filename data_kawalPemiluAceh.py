...
url = 'https://kawalpemilu.org/#pilpres:1'
...
ax.bar(pos,np_jokowi,width,color='red',label='Paslon01')

ax.bar([p + width for p in pos],np_prabowo,width,color='blue',label='Paslon02')
